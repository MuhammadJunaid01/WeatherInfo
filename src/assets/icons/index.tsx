...
export const WeatherIcon: React.FC<IProps> = React.memo(
  ({size, fill = '#212121'}) => {
    return (
      <Svg height={size} width={size} viewBox="0 0 512 512">
        <G>
          <Path
            d="M115.958,269.922c16.999-10.12,36.842-15.916,58.04-15.916c2.556,0,5.127,0.078,7.682,0.234
          ...
          />
          <Path
            d="M431.997,298c-0.031,0-0.062,0.008-0.101,0.008c0.054-1.332,0.101-2.665,0.101-4.004
